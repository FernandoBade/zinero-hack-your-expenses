...
├── .claude/      Claude agent settings and skill governance
...
| Choosing the right skill | [.claude/skills/index.md](.claude/skills/index.md) |
...
5. **Layer boundaries are enforced** — see segment CLAUDE.md files for layer rules. Violations are tracked as known risks in each skill's `refs/state.md`.
